...
private:
    // Comparator untuk QPoint agar bisa digunakan di std::set (untuk Brute Force)
    struct QPointLess {
    ...
    // Helper Functions (Semua harus static karena dipanggil dari comparePoints yang static)
